...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/chosen.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/flexslider.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/assets/css/color-01.css') }}">
    @livewireStyles
</head>
...
<body class="home-page home-01 ">
    ...
    <header id="header" class="header header-style-1">
                        ...
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-logo-top left-section">
                                <a href="index.html" class="link-to-home"><img
                                        src="{{ asset('templates/assets/images/logo-top-1.png') }}" alt="mercado"></a>
                            </div>
        ...
        @livewireScripts
        <script src="{{ asset('templates/assets/js/jquery-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
        <script src="{{ asset('templates/assets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
        <script src="{{ asset('templates/assets/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('templates/assets/js/jquery.flexslider.js') }}"></script>
        <script src="{{ asset('templates/assets/js/chosen.jquery.min.js') }}"></script>
        <script src="{{ asset('templates/assets/js/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('templates/assets/js/jquery.countdown.min.js') }}"></script>
        <script src="{{ asset('templates/assets/js/jquery.sticky.js') }}"></script>
