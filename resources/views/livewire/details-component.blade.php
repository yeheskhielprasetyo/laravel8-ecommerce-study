                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            <ul class="slides">
                                <li
                                    data-thumb="{{ asset('templates/assets/images/products') }}/{{ $product->image }}">
                                    <img src="{{ asset('templates/assets/images/products') }}/{{ $product->image }}"
                                        alt="{{ $product->image }}" />
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img
                                    src="{{ asset('templates/assets/images/social-list.png') }}" alt=""></a>
                        </div>
                                        ...
                                        <ol class="commentlist">
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1"
                                                ...
                                                <div id="comment-20" class="comment_container">
                                                    <img alt=""
                                                        src="{{ asset('templates/assets/images/author-avata.jpg') }}"
                                                        height="80" width="80">
                                    ...
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('product.details', ['slug' => $p_product->slug]) }}"
                                                ...
                                                <figure><img
                                                        src="{{ asset('templates/assets/images/products') }}/{{ $p_product->image }}"
                                                        alt="{{ $p_product->image }}"></figure>
                                            </a>
                                        </div>
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $r_product->slug]) }}"
                                            ...
                                            <figure><img
                                                    src="{{ asset('templates/assets/images/products') }}/{{ $r_product->image }}"
